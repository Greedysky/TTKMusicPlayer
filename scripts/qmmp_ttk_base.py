...
class QmmpTTKBaseModule():
    ...
    def get_home_directory(self):
        if self._ci_mode:
            return "/home/runner/work/TTKMusicPlayer"
    ...
    def __init__(self, mode):
        ...
        self._modules =  ("Effect/bitcrusher", "Effect/crystalizer" ,"Effect/echo", "Effect/mixer", "Effect/muffler", "Effect/silence", "Effect/sonic", "Effect/subwoofer", "Input/asap", "Input/ayfly", "Input/buzzic", "Input/dca", "Input/fc14", "Input/hively", "Input/ken", "Input/organya", "Input/psf", "Input/qoa", "Input/s98", "Input/sc68", "Input/soundmon", "Input/stsound", "Input/sunvox", "Input/tfmx", "Input/v2m", "Input/xgm", "Input/xmdx", "Input/xsf", "Visual/blurxrays", "Visual/flowwave", "Visual/infinity", "Visual/matrix", "Visual/mountain", "Visual/sonique", "Visual/voice", "Visual/volume", "Visual/vumeter")
