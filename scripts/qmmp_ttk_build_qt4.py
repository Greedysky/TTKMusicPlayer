...
class BuildModule(QmmpTTKBaseModule):
    ...
    def run(self):
        rm_str = "rm Makefile *.so"
        # 引入Qmmp环境配置
        os.environ['PKG_CONFIG_PATH'] = self.get_source_directory() + "/qmmp-lib/qt4/lib/qmmp/pkgconfig"
        # 遍历所有插件模块
        for module in self._modules:
            ...
            # 编译
            os.system("/usr/lib/x86_64-linux-gnu/qt4/bin/qmake")
