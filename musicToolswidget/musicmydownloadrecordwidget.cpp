...
void MusicMyDownloadRecordWidget::slDownloadProgressChanged(float percent, const QString &total, qint64 time)
{
...
void MusicMyDownloadRecordWidget::slCreateDownloadItem(const QString &name, qint64 time)
{
