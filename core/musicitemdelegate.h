...
class MUSIC_CORE_EXPORT MusicCheckBoxDelegate : public QItemDelegate
{
public:
...
class MUSIC_CORE_EXPORT MusicQueryTableDelegate : public MusicCheckBoxDelegate
{
public:
...
class MUSIC_CORE_EXPORT MusicProgressBarDelegate : public QItemDelegate
{
public:
