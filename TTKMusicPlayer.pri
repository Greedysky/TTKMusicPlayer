...
win32{
    ...
    msvc{
        ...
        LIBS += -L$$DESTDIR -lTTKqmmp -lTTKLibrary -lTTKUi -lTTKExtras -lTTKDumper -lttkzip -lzlib -luser32
    }
    ...
    gcc{
        ...
        LIBS += -L$$DESTDIR -lTTKqmmp -lTTKLibrary -lTTKUi -lTTKExtras -lTTKDumper -lttkzip -lzlib
    }
}
