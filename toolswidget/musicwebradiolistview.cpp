...
{
    QListWidgetItem *item = new QListWidgetItem(QIcon(QPixmap(":/radio/guowai"))
                                                ,tr("guowai"),this);
    item->setSizeHint(QSize(80,90));
    addItem(item);
    QListWidgetItem *item1 = new QListWidgetItem(QIcon(QPixmap(":/radio/jiaotong"))
                                                ,tr("jiaotong"),this);
    item1->setSizeHint(QSize(80,90));
    addItem(item1);
    QListWidgetItem *item2 = new QListWidgetItem(QIcon(QPixmap(":/radio/jingji"))
                                                ,tr("jingji"),this);
    item2->setSizeHint(QSize(80,90));
    addItem(item2);
    QListWidgetItem *item3 = new QListWidgetItem(QIcon(QPixmap(":/radio/music"))
                                                ,tr("music"),this);
    item3->setSizeHint(QSize(80,90));
    addItem(item3);
    QListWidgetItem *item4 = new QListWidgetItem(QIcon(QPixmap(":/radio/news"))
                                                ,tr("news"),this);
    item4->setSizeHint(QSize(80,90));
    addItem(item4);
    QListWidgetItem *item5 = new QListWidgetItem(QIcon(QPixmap(":/radio/quyi"))
                                                ,tr("quyi"),this);
    item5->setSizeHint(QSize(80,90));
    addItem(item5);
    QListWidgetItem *item6 = new QListWidgetItem(QIcon(QPixmap(":/radio/shenghuo"))
                                                ,tr("shenghuo"),this);
    item6->setSizeHint(QSize(80,90));
    addItem(item6);
    QListWidgetItem *item7 = new QListWidgetItem(QIcon(QPixmap(":/radio/sports"))
                                                ,tr("sports"),this);
    item7->setSizeHint(QSize(80,90));
    addItem(item7);
    QListWidgetItem *item8 = new QListWidgetItem(QIcon(QPixmap(":/radio/zhongyang"))
                                                ,tr("zhongyang"),this);
    item8->setSizeHint(QSize(80,90));
    addItem(item8);
    QListWidgetItem *item9 = new QListWidgetItem(QIcon(QPixmap(":/radio/favorite"))
                                                ,tr("favorite"),this);
    item9->setSizeHint(QSize(80,90));
    addItem(item9);
    QListWidgetItem *item10 = new QListWidgetItem(QIcon(QPixmap(":/radio/latest"))
                                                ,tr("latest"),this);
