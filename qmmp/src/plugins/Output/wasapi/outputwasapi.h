...
private:
    ...
    using DSoundChannel = QPair<Qmmp::ChannelPosition, DWORD>;
    static QList<DSoundChannel> m_wasapi_pos; //channel position, mask
...
public:
    ...
    virtual Volume::VolumeFlags flags() const override final;
