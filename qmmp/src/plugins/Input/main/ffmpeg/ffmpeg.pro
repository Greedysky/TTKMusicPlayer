...
win32{
    LIBS += -L$$EXTRA_LIB_PATH/libtaglib/lib -ltag \
            -L$$EXTRA_LIB_PATH/libffmpeg/lib -lavcodec.dll -lavformat.dll -lavutil.dll -lswresample.dll
}

unix:!mac{
    QMAKE_CLEAN = $$DESTDIR/lib$${TARGET}.so
    LIBS += -L$$EXTRA_LIB_PATH/libtaglib/lib -ltag$$STATIC_LIB_SUFFIX \
            -L$$EXTRA_LIB_PATH/libffmpeg/lib -lavcodec -lavformat -lavutil -lswresample
}
