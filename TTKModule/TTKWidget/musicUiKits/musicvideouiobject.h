...
namespace TTK
{
    namespace UI
    {
        ...
        static constexpr const char *VideoBtnBarrageStyle = " \
            QToolButton{ border:none; background-image:url(:/video/btn_barrage_style_normal); } \
