...
{
    m_pixmap.load(G_BACKGROUND_PTR->artistPhotoDefaultPath());
    if(m_pixmap.isNull())
    {
...
void MusicLrcPosterItemWidget::drawTheme1(QPainter *painter)
{
    ...
    const QString &title = QString("--- %1 ● %2").arg(MusicUtils::String::artistName(m_title), MusicUtils::String::songName(m_title));
