...
void MusicWebFMRadioPlayWidget::positionChanged(qint64 position)
{
    ...
    m_ui->positionLabel->setText(QString("%1").arg(TTKTime::msecTimeToLabelJustified(position * MT_S2MS)));
...
void MusicWebFMRadioPlayWidget::durationChanged(qint64 duration)
{
    ...
    m_ui->durationLabel->setText(QString("/%1").arg(TTKTime::msecTimeToLabelJustified(duration * MT_S2MS)));
}
