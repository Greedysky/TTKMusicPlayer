 ...
 */
class MUSIC_NETWORK_EXPORT MusicDownLoadQueryXMToplistThread : public MusicDownLoadQueryToplistThread,
                                                               private MusicDownLoadXMInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicDownLoadQueryXMToplistThread)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicDownLoadQueryXMToplistThread(QObject *parent = nullptr);
