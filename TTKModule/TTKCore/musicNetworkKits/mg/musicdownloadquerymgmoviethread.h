 ...
 */
class MUSIC_NETWORK_EXPORT MusicDownLoadQueryMGMovieThread : public MusicDownLoadQueryMovieThread,
...
protected:
     ...
     */
    void readFromMusicMVAttribute(MusicObject::MusicSongInformation *info, int bitrate, bool more);
