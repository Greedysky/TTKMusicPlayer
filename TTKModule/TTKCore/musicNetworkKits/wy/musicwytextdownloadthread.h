...
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicWYTextDownLoadThread)
public:
    /*!
     * Object contsructor provide download URL\ save local path and download type.
     */
    MusicWYTextDownLoadThread(const QString &url, const QString &save, MusicObject::DownloadType type, QObject *parent = nullptr);
