...
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicDownLoadQueryWYAlbumThread)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicDownLoadQueryWYAlbumThread(QObject *parent = nullptr);
     ...
     */
    virtual void startToSingleSearch(const QString &album) override;
