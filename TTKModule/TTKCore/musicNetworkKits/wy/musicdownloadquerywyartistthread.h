 ...
 */
class MUSIC_NETWORK_EXPORT MusicDownLoadQueryWYArtistThread : public MusicDownLoadQueryArtistThread,
                                                              private MusicDownLoadWYInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicDownLoadQueryWYArtistThread)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicDownLoadQueryWYArtistThread(QObject *parent = nullptr);
