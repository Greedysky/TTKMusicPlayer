 ...
 */
class MUSIC_NETWORK_EXPORT MusicDownLoadQueryQQToplistThread : public MusicDownLoadQueryToplistThread,
                                                               private MusicDownLoadQQInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicDownLoadQueryQQToplistThread)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicDownLoadQueryQQToplistThread(QObject *parent = nullptr);
