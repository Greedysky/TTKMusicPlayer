 ...
 */
class MUSIC_NETWORK_EXPORT MusicDownLoadQueryBDPlaylistThread : public MusicDownLoadQueryPlaylistThread,
                                                                private MusicDownLoadBDInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicDownLoadQueryBDPlaylistThread)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicDownLoadQueryBDPlaylistThread(QObject *parent = nullptr);
