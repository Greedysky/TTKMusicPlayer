...
/*! @brief The class of migu query artist list download data from net.
 * @author Greedysky <greedysky@163.com>
 */
class TTK_MODULE_EXPORT MusicMGQueryArtistListRequest : public MusicQueryArtistListRequest
{
    Q_OBJECT
