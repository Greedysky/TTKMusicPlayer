#ifndef MUSICMGQUERYARTISTREQUEST_H
#define MUSICMGQUERYARTISTREQUEST_H
...
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicMGQueryArtistRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicMGQueryArtistRequest(QObject *parent = nullptr);
...
#endif // MUSICMGQUERYARTISTREQUEST_H
