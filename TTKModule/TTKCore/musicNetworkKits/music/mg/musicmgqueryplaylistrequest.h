#ifndef MUSICMGQUERYPLAYLISTREQUEST_H
#define MUSICMGQUERYPLAYLISTREQUEST_H
...
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicMGQueryPlaylistRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicMGQueryPlaylistRequest(QObject *parent = nullptr);
...
#endif // MUSICMGQUERYPLAYLISTREQUEST_H
