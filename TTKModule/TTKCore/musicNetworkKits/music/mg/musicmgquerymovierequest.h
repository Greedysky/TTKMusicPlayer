#ifndef MUSICMGQUERYMOVIEREQUEST_H
#define MUSICMGQUERYMOVIEREQUEST_H
 ...
 */
class TTK_MODULE_EXPORT MusicMGQueryMovieRequest : public MusicQueryMovieRequest
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicMGQueryMovieRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicMGQueryMovieRequest(QObject *parent = nullptr);
