...
/*! @brief The class of download the type of wangyi txt.
...
public:
     ...
     */
    MusicWYDownLoadTextRequest(const QString &url, const QString &save, MusicObject::DownloadType type, QObject *parent = nullptr);
