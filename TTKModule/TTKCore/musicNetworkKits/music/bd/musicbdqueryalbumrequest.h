#ifndef MUSICBDQUERYALBUMREQUEST_H
#define MUSICBDQUERYALBUMREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicBDQueryAlbumRequest : public MusicQueryAlbumRequest,
                                                      private MusicBDQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicBDQueryAlbumRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicBDQueryAlbumRequest(QObject *parent = nullptr);
...
#endif // MUSICBDQUERYALBUMREQUEST_H
