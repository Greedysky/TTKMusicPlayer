...
MusicBDQueryToplistRequest::MusicBDQueryToplistRequest(QObject *parent)
...
void MusicBDQueryToplistRequest::startToSearch(QueryType type, const QString &toplist)
{
    if(type == MusicQuery)
    {
...
void MusicBDQueryToplistRequest::startToSearch(const QString &toplist)
{
    if(!m_manager)
    {
        return;
...
void MusicBDQueryToplistRequest::downLoadFinished()
{
