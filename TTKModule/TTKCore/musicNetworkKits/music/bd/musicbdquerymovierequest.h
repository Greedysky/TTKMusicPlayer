#ifndef MUSICBDQUERYMOVIEREQUEST_H
#define MUSICBDQUERYMOVIEREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicBDQueryMovieRequest : public MusicQueryMovieRequest,
                                                      private MusicBDQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicBDQueryMovieRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicBDQueryMovieRequest(QObject *parent = nullptr);
...
#endif // MUSICBDQUERYMOVIEREQUEST_H
