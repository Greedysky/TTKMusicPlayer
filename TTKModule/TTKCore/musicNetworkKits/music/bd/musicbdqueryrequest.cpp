...
MusicBDQueryRequest::MusicBDQueryRequest(QObject *parent)
...
void MusicBDQueryRequest::startToSearch(QueryType type, const QString &text)
{
    if(!m_manager)
    {
        return;
...
void MusicBDQueryRequest::startToPage(int offset)
{
    if(!m_manager)
    {
        return;
...
void MusicBDQueryRequest::startToSingleSearch(const QString &text)
{
    if(!m_manager)
    {
        return;
...
void MusicBDQueryRequest::downLoadFinished()
{
...
void MusicBDQueryRequest::singleDownLoadFinished()
{
