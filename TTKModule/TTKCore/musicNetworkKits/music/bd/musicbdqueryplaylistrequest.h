#ifndef MUSICBDQUERYPLAYLISTREQUEST_H
#define MUSICBDQUERYPLAYLISTREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicBDQueryPlaylistRequest : public MusicQueryPlaylistRequest,
                                                         private MusicBDQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicBDQueryPlaylistRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicBDQueryPlaylistRequest(QObject *parent = nullptr);
...
#endif // MUSICBDQUERYPLAYLISTREQUEST_H
