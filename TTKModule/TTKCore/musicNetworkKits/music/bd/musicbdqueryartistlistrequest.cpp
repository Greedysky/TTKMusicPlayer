...
MusicBDQueryArtistListRequest::MusicBDQueryArtistListRequest(QObject *parent)
...
void MusicBDQueryArtistListRequest::startToPage(int offset)
{
    if(!m_manager)
    {
        return;
...
void MusicBDQueryArtistListRequest::startToSearch(const QString &artistlist)
{
...
void MusicBDQueryArtistListRequest::downLoadFinished()
{
