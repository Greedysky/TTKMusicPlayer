#ifndef MUSICBDQUERYREQUEST_H
#define MUSICBDQUERYREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicBDQueryRequest : public MusicAbstractQueryRequest,
                                                 private MusicBDQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicBDQueryRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicBDQueryRequest(QObject *parent = nullptr);
