...
/*! @brief The class of the kugou query toplist download data from net.
 * @author Greedysky <greedysky@163.com>
 */
class TTK_MODULE_EXPORT MusicKGQueryToplistRequest : public MusicQueryToplistRequest, private MusicKGQueryInterface
{
    Q_OBJECT
