...
void MusicKGQueryRecommendRequest::startToSearch(const QString &id)
{
    if(!m_manager)
    {
        return;
    ...
    const QUrl &musicUrl = MusicUtils::Algorithm::mdII(KG_RECOMMEND_URL, false).arg(117227).arg(50);
    m_interrupt = true;
