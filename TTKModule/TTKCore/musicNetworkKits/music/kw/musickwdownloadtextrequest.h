...
/*! @brief The class of download the type of kuwo txt.
...
public:
     ...
     */
    MusicKWDownLoadTextRequest(const QString &url, const QString &save, MusicObject::DownloadType  type, QObject *parent = nullptr);
