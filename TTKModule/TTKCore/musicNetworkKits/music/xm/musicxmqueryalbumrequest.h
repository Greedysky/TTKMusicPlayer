#ifndef MUSICXMQUERYALBUMREQUEST_H
#define MUSICXMQUERYALBUMREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicXMQueryAlbumRequest : public MusicQueryAlbumRequest,
                                                      private MusicXMQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicXMQueryAlbumRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicXMQueryAlbumRequest(QObject *parent = nullptr);
...
#endif // MUSICXMQUERYALBUMREQUEST_H
