#ifndef MUSICXMQUERYPLAYLISTREQUEST_H
#define MUSICXMQUERYPLAYLISTREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicXMQueryPlaylistRequest : public MusicQueryPlaylistRequest,
                                                         private MusicXMQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicXMQueryPlaylistRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicXMQueryPlaylistRequest(QObject *parent = nullptr);
...
#endif // MUSICXMQUERYPLAYLISTREQUEST_H
