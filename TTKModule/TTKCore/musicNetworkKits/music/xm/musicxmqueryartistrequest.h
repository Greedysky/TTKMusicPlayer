#ifndef MUSICXMQUERYARTISTREQUEST_H
#define MUSICXMQUERYARTISTREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicXMQueryArtistRequest : public MusicQueryArtistRequest,
                                                       private MusicXMQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicXMQueryArtistRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicXMQueryArtistRequest(QObject *parent = nullptr);
...
#endif // MUSICXMQUERYARTISTREQUEST_H
