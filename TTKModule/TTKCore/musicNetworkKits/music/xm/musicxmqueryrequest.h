#ifndef MUSICXMQUERYREQUEST_H
#define MUSICXMQUERYREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicXMQueryRequest : public MusicAbstractQueryRequest,
                                                 private MusicXMQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicXMQueryRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicXMQueryRequest(QObject *parent = nullptr);
