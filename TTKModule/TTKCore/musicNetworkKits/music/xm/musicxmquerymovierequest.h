#ifndef MUSICXMQUERYMOVIEREQUEST_H
#define MUSICXMQUERYMOVIEREQUEST_H
 ...
 */
class MUSIC_NETWORK_EXPORT MusicXMQueryMovieRequest : public MusicQueryMovieRequest,
                                                      private MusicXMQueryInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicXMQueryMovieRequest)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicXMQueryMovieRequest(QObject *parent = nullptr);
...
#endif // MUSICXMQUERYMOVIEREQUEST_H
