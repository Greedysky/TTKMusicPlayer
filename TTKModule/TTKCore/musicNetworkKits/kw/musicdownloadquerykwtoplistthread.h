 ...
 */
class MUSIC_NETWORK_EXPORT MusicDownLoadQueryKWToplistThread : public MusicDownLoadQueryToplistThread,
                                                               private MusicDownLoadKWInterface
{
    Q_OBJECT
    TTK_DECLARE_MODULE(MusicDownLoadQueryKWToplistThread)
public:
    /*!
     * Object contsructor.
     */
    explicit MusicDownLoadQueryKWToplistThread(QObject *parent = nullptr);
