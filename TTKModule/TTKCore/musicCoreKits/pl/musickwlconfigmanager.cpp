...
void MusicKWLConfigManager::readPlaylistConfig(MusicSongItems &musics)
{
    MusicSongItem item;
...
void MusicKWLConfigManager::writePlaylistConfig(const MusicSongItems &musics, const QString &path)
{
    Q_UNUSED(musics);
    Q_UNUSED(path);
}
