...
#define TTKMUSIC_VERSION_STR    "2.12.0.0"
#define TTKMUSIC_VERSION_WSTR   L"2.12.0.0"
#define TTKMUSIC_VER_TIME_STR   "(2020/04/25)"

#define TTKMUSIC_MAJOR_VERSION 2
#define TTKMUSIC_MIDLE_VERSION 12
#define TTKMUSIC_MINOR_VERSION 0
#define TTKMUSIC_PATCH_VERSION 0

#define TTKMUSIC_VERSION 0x02C00
