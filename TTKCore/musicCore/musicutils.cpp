...
QList<QColor> MusicUtils::UString::readColorConfig(const QString &value)
{
    QList<QColor> colors;
...
QString MusicUtils::UString::writeColorConfig(const QColor &color)
{
    QString value;
...
QString MusicUtils::UString::writeColorConfig(const QList<QColor> &colors)
{
    QString value;
