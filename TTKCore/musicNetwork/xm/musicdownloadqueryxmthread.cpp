...
void MusicDownLoadQueryXMThread::readFromMusicSongAttribute(MusicObject::MusicSongInfomation *info,
...
int MusicDownLoadQueryXMThread::map2NormalBitrate(int bitrate)
{
