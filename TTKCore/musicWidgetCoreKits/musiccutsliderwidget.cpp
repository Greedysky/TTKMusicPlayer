    ...
    : QWidget(parent)
{
    ...
    m_leftControl->setGeometry(-PAINT_BUTTON_WIDTH/2, PAINT_BUTTON_HEIGHT,
                                PAINT_BUTTON_WIDTH, PAINT_BUTTON_HEIGHT);
    m_rightControl->setGeometry(-PAINT_BUTTON_WIDTH/2, PAINT_BUTTON_HEIGHT,
                                PAINT_BUTTON_WIDTH, PAINT_BUTTON_HEIGHT);
