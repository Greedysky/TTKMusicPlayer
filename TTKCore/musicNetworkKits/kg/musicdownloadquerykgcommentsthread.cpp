...
void MusicDownLoadQueryKGCommentsThread::startToSearch(QueryType type, const QString &name)
{
    Q_UNUSED(type);
...
void MusicDownLoadQueryKGCommentsThread::startToSearch(int offset)
{
    if(!m_manager)
    {
        return;
