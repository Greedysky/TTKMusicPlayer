...
void MusicDownLoadQueryWYCommentsThread::startToSearch(QueryType type, const QString &name)
{
    Q_UNUSED(type);
...
void MusicDownLoadQueryWYCommentsThread::startToSearch(int offset)
{
    if(!m_manager)
    {
        return;
