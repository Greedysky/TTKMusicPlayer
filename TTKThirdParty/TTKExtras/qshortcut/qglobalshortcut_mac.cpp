...
quint32 QGlobalShortcutPrivate::nativeKeycode(Qt::Key key)
{
    ...
    KLGetKeyboardLayoutProperty(layout, kKLKind, TTKConstCast(const void**, TTKReinterpretCast(void**, &layoutKind)));
    ...
    { // no Unicode available
        ...
        char *data;
        KLGetKeyboardLayoutProperty(layout, kKLKCHRData, TTKConstCast(const void**, TTKReinterpretCast(void**, &data)));
        int ct = *TTKReinterpretCast(short*, data + 258);
        for(int i = 0; i < ct; ++i)
        {
    ...
    char *data;
    KLGetKeyboardLayoutProperty(layout, kKLuchrData, TTKConstCast(const void**, TTKReinterpretCast(void**, &data)));
